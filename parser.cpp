...
static const char *const yytname[] =
{
  ...
  "TINTEGER", "TDOUBLE", "EQ", "NE", "LT", "LE", "GT", "GE", "ASSIGNMENT",
  "TLPAREN", "TRPAREN", "TLBRACE", "TRBRACE", "TCOMMA", "TDOT", "PLUS",
  "MINUS", "MUL", "DIV", "TRETURN", "TEXTERN", "$accept", "program",
...
#line 1194 "parser.cpp"
  ...
  case 13: /* var_decl: ident ident ASSIGNMENT expr  */
#line 73 "parser.y"
...
#line 77 "parser.y"
                { (yyval.stmt) = new NExternDeclaration(*(yyvsp[-4].ident), *(yyvsp[-3].ident), *(yyvsp[-1].varlist)); delete (yyvsp[-1].varlist); }
#line 1206 "parser.cpp"
    break;

  case 15: /* func_decl: ident ident TLPAREN func_decl_args TRPAREN block  */
#line 81 "parser.y"
                        { (yyval.stmt) = new NFunctionDeclaration(*(yyvsp[-5].ident), *(yyvsp[-4].ident), *(yyvsp[-2].varlist), *(yyvsp[0].block)); delete (yyvsp[-2].varlist); }
...
#line 85 "parser.y"
                             { (yyval.varlist) = new VariableList(); (yyval.varlist)->push_back((yyvsp[0].var_decl)); }
...
#line 1248 "parser.cpp"
  ...
  case 22: /* expr: ident ASSIGNMENT expr  */
#line 96 "parser.y"
...
#line 97 "parser.y"
                                           { (yyval.expr) = new NMethodCall(*(yyvsp[-3].ident), *(yyvsp[-1].exprlist)); delete (yyvsp[-1].exprlist); }
...
#line 100 "parser.y"
                         { (yyval.expr) = new NBinaryOps(*(yyvsp[-2].expr), (yyvsp[-1].token), *(yyvsp[0].expr)); }
